export default function ContactUs() {
  return (
    <section className="relative z-10 overflow-hidden bg-slate-900 py-20 lg:py-[120px] min-h-screen">
      <div className="container">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="relative rounded-lg bg-slate-900 p-8 shadow-lg sm:p-12">
              <form>
                <div className="mb-6">
                  <input
                    type="text"
